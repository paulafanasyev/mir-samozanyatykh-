...
class Settings(BaseSettings):
    ...
    # Безопасность
    SECRET_KEY: str = ""
    BANK_ENCRYPTION_KEY: str = ""  # 32-byte URL-safe base64 key for AES-256-GCM
    ...
    # CosyVoice 3.0 (голосовой ассистент)
...
if settings.ENVIRONMENT == "production":
    if len(settings.SECRET_KEY) < 64:
        raise ValueError(
            "SECRET_KEY must be at least 64 chars in production.\n"
