...
TARIFFS = {
    "self_employed_free": {"name": "Самозанятый — Free", "price": 0, "description": "Бесплатное рабочее пространство для самозанятого с лимитами на использование.", "limits": {"clients": 25, "contracts_per_month": 10, "invoices_per_month": 30, "storage_mb": 500}},
    "self_employed_pro": {"name": "Самозанятый — Pro", "price": 499, "description": "Расширенное рабочее пространство без базовых лимитов: CRM, документы, аналитика и продвижение.", "limits": {"clients": -1, "contracts_per_month": -1, "invoices_per_month": -1, "storage_mb": 5000}},
    "business_start": {"name": "Business Start", "price": 1490, "description": "Для ИП и небольших работодателей: команда, CRM, маркетплейс и документы.", "limits": {"clients": -1, "contracts_per_month": -1, "invoices_per_month": -1, "storage_mb": 10000}},
    "business_pro": {"name": "Business Pro", "price": 2990, "description": "Для компаний: расширенная CRM, роли, аналитика, документы и интеграции.", "limits": {"clients": -1, "contracts_per_month": -1, "invoices_per_month": -1, "storage_mb": 25000}},
    "enterprise": {"name": "Corporate", "price": 7990, "description": "Корпоративный контур с командами, расширенными ролями, API и индивидуальными условиями.", "limits": {"clients": -1, "contracts_per_month": -1, "invoices_per_month": -1, "storage_mb": 100000}},
}
