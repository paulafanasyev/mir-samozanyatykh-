...
check('version synchronized','APP_VERSION: str = "8.4.33"' in config and '"version": "8.4.33"' in (ROOT/'frontend/package.json').read_text() and 'version: 8.4.33+858' in (ROOT/'mobile/pubspec.yaml').read_text())
