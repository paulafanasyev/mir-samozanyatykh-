...
<div className="text-orange-600 text-xs mt-2 flex items-center gap-1">
...
<div className="text-3xl font-bold text-amber-600">{stats.level}</div>
...
className="flex-1 py-2 bg-orange-50 text-orange-700 rounded-lg text-sm hover:bg-orange-100 flex items-center justify-center gap-2"
...
{i === 1 && <TrendingUp className="w-4 h-4 text-orange-400" />}

{i === 2 && <Crown className="w-4 h-4 text-amber-400" />}

{i === 3 && <Trophy className="w-4 h-4 text-amber-400" />}

<span className={`font-semibold text-sm ${isCurrent ? 'text-amber-700' : 'text-slate-700'}`}>
...
<div className="mt-2 text-xs font-medium text-amber-600">Ваш уровень</div>
