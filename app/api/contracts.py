...
from app.core.security import get_current_user, generate_simple_signature, verify_simple_signature
...
async def generate_contract(
    ...
    template_type = data.template_id  # используем template_id как тип для простоты
    ...
    filepath = f"data/contracts/{filename}"
...
async def sign_contract(
    ...
    if contract.pdf_path and os.path.exists(contract.pdf_path):
        ...
        with open(contract.pdf_path, "wb") as f:
            f.write(pdf_bytes)
