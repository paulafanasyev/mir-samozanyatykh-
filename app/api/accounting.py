"""
API бухгалтерии — Мир Самозанятых v8.0
...
async def create_tax_report(
    ...
    # Расчёт налога
    tax_rate = Decimal("0.04") if data.report_type == "npd_quarterly" else Decimal("0.13")
    taxable_amount = total_income - total_expense - deduction_total
    if taxable_amount < 0:
...
async def get_dashboard(
    ...
    return DashboardStats(
        ...
        pending_invoices=0,  # TODO: реализовать
        overdue_invoices=overdue_invoices,
        transactions_count=0,  # TODO: реализовать
