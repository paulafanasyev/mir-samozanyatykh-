"""
Главный файл FastAPI приложения Мир Самозанятых v6.8
...
# Импорт роутеров
from app.api import auth, users, sales, contracts, crm, svetlana, websocket, subscriptions, flutter, email_campaigns, analytics, import_export
