...
import { LayoutDashboard, Package, FileText, Users, Handshake, FileSignature, UserCircle, Mic, LogOut, Menu, X, Shield, Gift, Bell, CheckSquare, Calendar, Plug } from 'lucide-react'
