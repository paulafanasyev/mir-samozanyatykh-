    ...
    <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6">
          ...
          <form onSubmit={handleCreateDeduction} className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="md:col-span-4 flex gap-2">
              <button type="submit" className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700">Sokhranit</button>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6">
          ...
          <form onSubmit={handleCreateReport} className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-3 flex gap-2">
              <button type="submit" className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700">Sozdat otchyot</button>
      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="p-8 text-center text-slate-400">Net sozdannykh otchyotov. Sozdayte pervyy otchyot vyше.</div>
        ) : (
              ...
              <tbody>
                {reports.map(r => (
                  <tr key={r.id} className="border-t border-slate-100 hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3 text-center">
                      {r.status === 'draft' && (
                        <button onClick={() => submitReport(r.id)} className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                          Podat
                        </button>
                      )}
                    </td>
